...
The **Law of Large Numbers** states that as the number of trials ( n ) increases, the empirical probability ( \hat{P} ) approaches the true probability ( P ).
...
plot(empirical_prob, type = "l", col = "blue", ylim = c(0, 1),
     main = "Law of Large Numbers", xlab = "Number of Flips", ylab = "Empirical Probability")
...
## More Distributions & Probability Density Functions
...
<br> \### 9. Chi-Squared Distribution (카이제곱 분포)
...
\
$k$ is the degrees of freedom (자유도).
