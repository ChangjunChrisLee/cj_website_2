...
-   응답 데이터는 보통 **long format**으로 정리

-   `mlogit`는 선택모형 추정을 위해 롱폼을 요구

-   `mlogit`는 random utility 기반의 multinomial logit 모델을 최대우도로
    추정하는 패키지
...
survey_data <- tibble::tribble(
  ~id, ~task, ~alt, ~choice, ~Mode,     ~Length,   ~Cost,   ~Focus,
   1,    1,   "A",    1,    "Face",    "2weeks", "Free",  "Practice",
   1,    1,   "B",    0,    "Hybrid",  "4weeks", "50k",   "Writing",
   1,    2,   "A",    0,    "Online",  "8weeks", "100k",  "Theory",
   1,    2,   "B",    1,    "Face",    "4weeks", "Free",  "Writing",

   2,    1,   "A",    0,    "Face",    "2weeks", "Free",  "Practice",
   2,    1,   "B",    1,    "Hybrid",  "4weeks", "50k",   "Writing",
   2,    2,   "A",    1,    "Online",  "8weeks", "100k",  "Theory",
   2,    2,   "B",    0,    "Face",    "4weeks", "Free",  "Writing"
)
