...
-   e.g.) Let's summarize various performance evaluation indicators such
    as model='rf' / model='dt'
...
-   **Specificity**: Proportion of true negative predictions among all actual
        negative instances. Also known as true negative rate.
        
    $\frac{TN}{TN + FP}$

-   **FP Rate**: Proportion of false positive predictions among all actual
        negative instances. Also known as false positive rate.
        
    $\frac{FP}{FP + TN}$

-   **F1 Score**: Harmonic mean of precision and recall. Provides a balanced
        measure between the two.
    
    $\frac{2 \cdot (Precision \cdot Recall)}{Precision + Recall}$

-   **Kappa**: Measures the agreement between the model's predictions and the
        expected outcomes, taking into account the possibility of
        agreement by chance.
